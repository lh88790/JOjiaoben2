...
credits:Button(
        ...
        "选择单人传送",
        function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/brosula123/Teleport-script-made-by-Getmepink-Roblox-Yt--Bl-xzScript/main/To%20script?token=GHSAT0AAAAAACTWZVXBNPRNJR3XJYDXVVU6ZTSJNDQ"))()
        end)
