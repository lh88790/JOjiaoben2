...
GetKey.MouseButton1Click:Connect(function()
   setclipboard("Script114514")
end)
 
local function validateKey(key)
    return key == "Script114514" -- Replace this with your key
end
 
CheckKey.MouseButton1Click:Connect(function()
    local enteredKey = TextBox.Text
    if validateKey(enteredKey) then
        TextBox.PlaceholderText = "卡密正确，你真的太棒了!"
        TextBox.Text = ""
        wait(1)
        ScreenGui:Destroy()
 
-- Put Your Script Here
loadstring(game:HttpGet("https://raw.githubusercontent.com/lh88790/JOjiaoben2/main/JO脚本.lua"))()
 
    else
        TextBox.PlaceholderText = "卡密错误."
        TextBox.Text = ""
        wait(1)
        TextBox.PlaceholderText = "请输入脚本..."
        TextBox.Text = ""
    end
end)